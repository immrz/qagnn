...
class LMEdgeEncoder:
    def __init__(self, emb_size):
        ...
        with open(os.path.join(data_root, 'cpnet', 'concept.txt'), 'r', encoding='utf8') as fi:
    ...
    def tokenize_and_encode(self, trip_txt, device, batch_size=256):
        """
...
def make_one_hot(labels, C):
    '''
    Converts an integer label to a one-hot vector.
